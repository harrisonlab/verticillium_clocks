...
Usage='sbatch $ProgDir/sub_salmon_1.1.sh <Transcriptome.fa> <Read_F.fq> <Read_R.fq> <OutputFi
lePath>'
...
# Collect inputs
# ---------------
export PATH=${PATH}:/home/lopeze/miniconda3/pkgs/salmon-1.1.0-hf69c8f4_0/bin/
